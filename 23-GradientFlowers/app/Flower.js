function flowerFactory(scene) {
    ...
    this.flower = function(x,y,z) {
     ...
     //    mesh = new THREE.Mesh( leafGeo, leafMat );    
        ...
        var flat2CupGeo = this.morphGeo(flatDumpling, funcCup);       // nice gradient effect.
        var material0 = new THREE.MeshPhongMaterial( { ambient: 0xff00ff, color: "yellow", specular: 0xff00ff, shininess: 50,shading: THREE.SmoothShading, 
                morphTargets: true }  );
        var retmesh = this.addMorphMesh(x,y,z, flat2CupGeo, newMaterial, 1,.7, -0.01 * speed, false, 1);
        ...
        this.addMorphMesh(x,y,z, flat2CupGeo, newMaterial, 1,.5, -0.01 * speed, false, 1.2);
        ...
        this.addMorphMesh(x,y,z, flat2CupGeo, newMaterial, 1,.4, -0.01 * speed, false, 1.4);
        return retmesh;
    }
