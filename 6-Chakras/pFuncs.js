...
flatDisk = function(u,v) { return       dumpling(u, v, 1, 0, 0, 0, 8, 8, 0); }
funcLeaves = function(u,v) { return     dumpling(u, v, -1, 0.5, .5, .8, 16, 7, 0); }
funcCup = function(u,v) { return        dumpling(u, v, 1, 1, 3, 1.7, 8, 4, 0); }
funcMuladhara = function(u,v) { return  dumpling(u, v, 1, 1.5, 2.5, .2, 4, 7, 0); }
funcFlatChakra = function(u,v) { return dumpling(u, v, 0, .1, 2, 1, 4, 12, 0); }
funcCupChakra = function(u,v) { return  dumpling(u, v, 2, 0.1, 3, 1.7, 4, 7, 0); }
funcGetCupFunc = function(nPetals) {
    //return function(u,v) { return  dumpling(u, v, 2, 1, 3, 1.7, nPetals, 7, 0); };
    return function(u,v) { return dumpling(u, v, 1, 1, 3, 1.7, nPetals, 4, 0); };
}
funcGetFlatFunc = function(nPetals, flatness, size, offsetRadians) {
    return function(u,v) { return dumpling(u, v, 0, flatness, 2, 1, nPetals, size, offsetRadians); };
}

dumpling = function(u,v, openOrClose, overallHeight, petalPeak, petalTrough, nPetals, scale, offsetRadians) {
    ...
    x = temprad*Math.cos(theta+offsetRadians);
    y = temprad*Math.sin(theta+offsetRadians);
