...
function init() {
    ...
    //var el = document.getElementById('batman-path');
    var el = document.querySelector("#batman-path");
    _scene.add(createMesh(drawShape(el, 'glyph1')));
    _scene.add(createMesh(drawShape(el, 'glyph2')));
    _scene.add(createMesh(drawShape(el, 'glyph3')));
    _scene.add(createMesh(drawShape(el, 'glyph4')));
    _scene.add(createMesh(drawShape(el, 'glyph5')));
    _scene.add(createMesh(drawShape(el, 'glyph7')));
    _scene.add(createMesh(drawShapeWithHole(el, 'glyph8', 'glyph9')));
    //_scene.add(createMesh(drawShape(el, 'glyph9')));
...
//    THREE.GeometryUtils.scale(geom, new THREE.Vector3(s,s,s));
    //geom.applyMatrix(new THREE.Matrix4().makeTranslation(-2, 0, -40));
