...
function init() {
    ...
    // var simpleMaterial = new THREE.MeshBasicMaterial( { map: texture,
		  //  WrapS : THREE.RepeatWrapping,
		  //  WrapT : THREE.RepeatWrapping
    //  } );
	//_shaderMaterial.wrapS = _shaderMaterial.wrapT = THREE.RepeatWrapping;
	//_shaderMaterial.repeat.set( 2, 2 );
	...
	pMaterial = new THREE.ParticleBasicMaterial({ 
		size: 1.0, opacity: .6, transparent: true,
		map: smokeTexture,
		blending: THREE.AdditiveBlending, color: 0x111111 
	});
   	var particleSystem = new THREE.ParticleSystem(cloudGeo, pMaterial);
