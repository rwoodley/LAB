...
var _pointLightColor = 0xaa00aa;
var _floorColor = 0x00ff00;
var _flowerColor = 0x00ffaa;
...
function init() {
	...
	_camera.position.y = 32;
	_camera.position.z = 65;
...
function drawCube(x,y,z, func1, func2) {
    ...
    var material = new THREE.MeshPhongMaterial( { ambient: 0x555555, color: 0x999999, specular: 0xffffff, shininess: 50,
